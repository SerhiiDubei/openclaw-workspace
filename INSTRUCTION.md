...
2. Перевірити чи є файл `memory/users/{username}/sessions/YYYY-MM-DD.md`
3. Якщо НІ — створити його
4. Записувати ключові моменти розмови
