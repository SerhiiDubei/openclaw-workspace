...
2. **Створити/відкрити файл сесії** — `memory/users/{username}/sessions/YYYY-MM-DD.md`
3. **Записувати КОЖНЕ повідомлення** в реальному часі:
   - Час (HH:MM)
   - Хто пише ([User] / [Assistant])
   - Текст повідомлення (коротко, суть)

**Правила розбиття сесій:**
- Якщо мовчання > 30 хвилин — створити нову сесію з тим же днем
- Нова дата — нова сесія
...
### 14:30
**[User]:** Текст повідомлення користувача

**[Assistant]:** Текст відповіді асистента
...
**Автоматично після кожного повідомлення:**
- Додати запис в сесію
