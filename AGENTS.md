...
### Після відповіді (ОБОВ'ЯЗКОВО!):
1. **Відкрити файл сесії**
2. **Додати запис:**
   ```markdown
   ### HH:MM
   **[User]:** {повний текст повідомлення користувача}
   
   **[Assistant]:** {повний текст відповіді}
   ```
3. **Зберегти файл** — не чекати, записати одразу!
